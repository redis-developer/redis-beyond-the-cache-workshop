...
workshop_dir="${repo_root}/java-springboot/${workshop_id}"
manager_dir="${repo_root}/java-springboot/${manager_module}"
...
copy_dir "$workshop_dir" "${context_dir}/java-springboot/${workshop_id}"
copy_dir "$manager_dir" "${context_dir}/java-springboot/${manager_module}"
