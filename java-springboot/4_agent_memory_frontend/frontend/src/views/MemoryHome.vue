...
const FALLBACK_STAGE_IDS = ['problem', 'solution', 'working-memory', 'long-term-memory'];
const FALLBACK_STEPS = ['The Problem', 'The Solution', 'Working Memory', 'Long-Term Memory'];
...
export default {
  ...
  methods: {
    async loadContent() {
      ...
      try {
        this.content = await loadWorkshopContentView('memory-home');
      } catch (error) {
