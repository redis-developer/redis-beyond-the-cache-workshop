...
public record PortalSessionProperties(
    ...
    String marketingPreferenceRedisKeyPrefix
) {
    ...
    private static final String DEFAULT_MARKETING_PREFERENCE_REDIS_KEY_PREFIX = "platform:portal:marketing_preferences:";
    ...
    public PortalSessionProperties {
        ...
        marketingPreferenceRedisKeyPrefix = StringUtils.hasText(marketingPreferenceRedisKeyPrefix)
            ? marketingPreferenceRedisKeyPrefix.trim()
            : DEFAULT_MARKETING_PREFERENCE_REDIS_KEY_PREFIX;
    }
}
